...
import mpi.aida.graph.similarity.context.lsh.Counter;
...
//				System.out.println(counter);
	...
	public static mpi.aida.graph.similarity.context.lsh.preprocessing.IntCounter getIntCounter(int keyphrase, int[] tokens){
		...
		entries = null;
		return new mpi.aida.graph.similarity.context.lsh.preprocessing.IntCounter(keyphrase, keys, vals, totalCount);
	}
